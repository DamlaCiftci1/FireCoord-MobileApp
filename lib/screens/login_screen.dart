...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    // Merkez rolü mobil uygulamada desteklenmez
    if (user.isMerkez) {
      setState(() => _error = 'Merkez yönetimi için web uygulamasını kullanın.\nBu uygulama şef ve ekip üyelerine özeldir.');
                ...
                children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            _quickBtn('👨‍🚒', 'Şef 2', 'mehmet/1234', () => _quickLogin('mehmet', '1234')),
                            const SizedBox(width: 8),
                            _quickBtn('🧑‍🚒', 'Ekip Üyesi', 'ekip1/1234', () => _quickLogin('ekip1', '1234')),
                          ],
                        ),
                      ],
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Text('Firebase Bağlı', style: TextStyle(color: AppColors.textMuted, fontSize: 11)),
                      const SizedBox(width: 20),
                      _statusDot(AppColors.info), const SizedBox(width: 5),
                      const Text('Şef & Ekip Girişi', style: TextStyle(color: AppColors.textMuted, fontSize: 11)),
                    ],
                  ),
                ],
              ),
